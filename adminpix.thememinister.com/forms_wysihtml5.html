...
<!-- Mirrored from adminpix.thememinister.com/forms_wysihtml5.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:09 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body class="hold-transition fixed sidebar-mini">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview active">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="active"><a href="forms_wysihtml5.html">Wysihtml5</a></li>
                                    <li>
                                        <a href="#">Form Wizard
                                ...
                                <div class="panel-body">
                                    <form method="post">
                                        <div class="form-group">
                                            <textarea id="textarea" class="form-control" rows="15" placeholder="Enter text ..."></textarea>
                                        </div>
                                    </form>
                                </div>
                            </div>
        ...
        <script src="assets/plugins/bootstrap-wysihtml5/wysihtml5.js"></script>
        <script src="assets/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script>
        <script src="assets/plugins/bootstrap-wysihtml5/wysihtml5-active.js"></script>
        <!-- START THEME LABEL SCRIPT -->
        <script src="assets/dist/js/theme.js"></script>
    </body>

<!-- Mirrored from adminpix.thememinister.com/forms_wysihtml5.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:12 GMT -->
</html>