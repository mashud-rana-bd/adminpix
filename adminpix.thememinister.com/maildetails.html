...
<!-- Mirrored from adminpix.thememinister.com/maildetails.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:46:27 GMT -->
<head>
        <meta charset="utf-8">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview active">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="active"><a href="maildetails.html">Mailbox Details</a></li>
                                        ...
                                        <div class="col-xs-4">
                                            <div class="inbox-avatar"><img src="assets/dist/img/user2-160x160.png" class="img-circle border-green" alt="img">
                                                <div class="inbox-avatar-text hidden-xs hidden-sm">
                                                    <div class="avatar-name">Tanzil Hasan</div>
                                    ...
                                    <div class="row m-0">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-9 p-0 inbox-mail">
                                            <div class="inbox-avatar p-20 border-btm">
                                                <img src="assets/dist/img/avatar5.png" class="border-green hidden-xs hidden-sm" alt="img">
                                                <div class="inbox-avatar-text">
                                                    <div class="avatar-name"><strong>From: </strong>
                                                        Tanjil Ahmed - <em><a href="cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="88fce9e6e2e1e4d7e9e0e5edecc8edf0e9e5f8e4eda6ebe7e5">[email&#160;protected]</a></em>
                                                    </div>
...
<!-- Mirrored from adminpix.thememinister.com/maildetails.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:46:28 GMT -->
</html>