...
<!-- Mirrored from adminpix.thememinister.com/list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:47 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body class="hold-transition fixed sidebar-mini">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div id="nestable-menu" class="m-b-20">
                                <button type="button" data-action="expand-all" class="btn btn-base">Expand All</button>
                                <button type="button" data-action="collapse-all" class="btn btn-base">Collapse All</button>
                            </div>
                        </div>
        ...
        <script src="assets/plugins/Nestable/nestable-active.js"></script>
        <!-- START THEME LABEL SCRIPT -->
        <script src="assets/dist/js/theme.js"></script>
    </body>

<!-- Mirrored from adminpix.thememinister.com/list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:48 GMT -->
</html>