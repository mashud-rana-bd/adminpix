...
<!-- Mirrored from adminpix.thememinister.com/forms_editor_ck.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:44:59 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body class="hold-transition fixed sidebar-mini">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview active">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="active"><a href="forms_editor_ck.html">CK Editor</a></li>
        ...
        <script src="assets/plugins/ckeditor/ckeditor-active.js"></script>
        <!-- START THEME LABEL SCRIPT -->
        <script src="assets/dist/js/theme.js"></script>
    </body>

<!-- Mirrored from adminpix.thememinister.com/forms_editor_ck.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:01 GMT -->
</html>