...
<!-- Mirrored from adminpix.thememinister.com/slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:46:32 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body class="hold-transition fixed sidebar-mini">
        ...
        <script src="assets/plugins/ion/js/ion.rangeSlider.min.js"></script>
        <script src="assets/plugins/ion/js/ion-active.js"></script>
        <script src="assets/plugins/moment/moment.js"></script>
        <!-- START THEME LABEL SCRIPT -->
        <script src="assets/dist/js/theme.js"></script>
    </body>

<!-- Mirrored from adminpix.thememinister.com/slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:46:35 GMT -->
</html>