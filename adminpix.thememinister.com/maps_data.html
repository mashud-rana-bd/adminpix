...
<!-- Mirrored from adminpix.thememinister.com/maps_data.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:46:07 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body class="hold-transition fixed sidebar-mini">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview active">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="active"><a href="maps_data.html">Data Maps</a></li>
        ...
        <script src="assets/plugins/datamaps/d3.min.js"></script>
        <script src="assets/plugins/datamaps/topojson.min.js"></script>
        <script src="assets/plugins/datamaps/datamaps.all.min.js"></script>
        <script src="assets/plugins/datamaps/datamaps-active.js"></script>
    </body>

<!-- Mirrored from adminpix.thememinister.com/maps_data.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:46:10 GMT -->
</html>