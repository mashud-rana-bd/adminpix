...
<!-- Mirrored from adminpix.thememinister.com/forms_basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:44:48 GMT -->
<head>
        <meta charset="utf-8">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="exampleName" aria-describedby="emailHelp" placeholder="Enter Your Name">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleTextarea">Adminpixarea</label>
                                ...
                                <div class="panel-body">
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <fieldset>
                                                    <legend>Circled Checkbox</legend>
