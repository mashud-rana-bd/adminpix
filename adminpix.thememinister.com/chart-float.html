...
<!-- Mirrored from adminpix.thememinister.com/chart-float.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:52 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body class="hold-transition fixed sidebar-mini">
                    ...
                    <div class="sidebar">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview active">
                                ...
                                <ul class="treeview-menu">
                                    <li class="active"><a href="chart-float.html">Float Chart</a></li>
        ...
        <script src="assets/plugins/flot/flot-active.js"></script>
        <!-- START THEME LABEL SCRIPT -->
        <script src="assets/dist/js/theme.js"></script>
    </body>

<!-- Mirrored from adminpix.thememinister.com/chart-float.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:55 GMT -->
</html>