...
<!-- Mirrored from adminpix.thememinister.com/code_editor.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:46:53 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body class="hold-transition fixed sidebar-mini">
        ...
        <script src="assets/plugins/codemirror/addon/search/searchcursor.js"></script>
        <script src="assets/plugins/codemirror/addon/search/search.js"></script>
        <script src="assets/plugins/codemirror/addon/dialog/dialog.js"></script>
        <script src="assets/plugins/codemirror/addon/edit/matchbrackets.js"></script>
        <script src="assets/plugins/codemirror/addon/edit/closebrackets.js"></script>
        <script src="assets/plugins/codemirror/addon/comment/comment.js"></script>
        <script src="assets/plugins/codemirror/addon/wrap/hardwrap.js"></script>
        <script src="assets/plugins/codemirror/addon/fold/foldcode.js"></script>
        <script src="assets/plugins/codemirror/addon/fold/brace-fold.js"></script>
        ...
        <script src="assets/plugins/codemirror/addon/scroll/simplescrollbars.js"></script>
        <script src="assets/plugins/codemirror/codemirror-active.js"></script>
        <!-- START THEME LABEL SCRIPT -->
        <script src="assets/dist/js/theme.js"></script>
    </body>

<!-- Mirrored from adminpix.thememinister.com/code_editor.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:47:07 GMT -->
</html>