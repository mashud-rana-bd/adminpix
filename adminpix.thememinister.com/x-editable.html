...
<!-- Mirrored from adminpix.thememinister.com/x-editable.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:19 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body class="hold-transition fixed sidebar-mini">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview active">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="active"><a href="x-editable.html">X-Editable</a></li>
                                </ul>
                            </li>
                            <li class="treeview">
                                <a href="#">
                                    ...
                                    <div class="table-responsive">
                                        <table id="user" class="table table-bordered table-striped">
                                            <tbody> 
                                                ...
                                                <tr>         
                                                    <td>Wysihtml5 (now support bootstrap 3 !!!). <a href="#" id="pencil"><i class="icon-pencil"></i>[edit]</a></td>
                                                    <td>
        ...
        <!-- jquery.mockjax -->
        <script src="assets/plugins/jquery-mockjax/jquery.mockjax.min.js"></script>
        <!-- momentjs --> 
        ...
        <script src="assets/plugins/bootstrap3-editable-1.5.1/bootstrap3-editable/js/bootstrap-editable.js"></script>
        <!-- typeaheadjs -->
        <script src="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/typeaheadjs/lib/typeahead.js"></script>
        <script src="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/typeaheadjs/typeaheadjs.js"></script>
        <!-- wysihtml5 -->
        <script src="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/wysihtml5/wysihtml5-0.3.0.min.js"></script>
        <script src="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/wysihtml5/bootstrap-wysihtml5-0.0.3.min.js"></script>
        <script src="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/wysihtml5/wysihtml5-0.0.3.js"></script>
        <!-- address input -->
        <script src="assets/plugins/bootstrap3-editable-1.5.1/inputs-ext/address/address.js"></script>
        <script src="assets/plugins/bootstrap3-editable-1.5.1/demo-mock.js"></script>
        <script src="assets/plugins/bootstrap3-editable-1.5.1/demo.js"></script>
        <!-- START THEME LABEL SCRIPT -->
        <script src="assets/dist/js/theme.js"></script>
    </body>

<!-- Mirrored from adminpix.thememinister.com/x-editable.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:34 GMT -->
</html>