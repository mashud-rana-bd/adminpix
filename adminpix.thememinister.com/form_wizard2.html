...
<!-- Mirrored from adminpix.thememinister.com/form_wizard2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:16 GMT -->
<head>
        <meta charset="utf-8">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-10 col-md-offset-1 text-center">
                                            <form method="post" class="f1 form2">
                                                <div class="f1-steps f2-steps col-md-4">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="f1-phone">Contact</label>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" placeholder="Website Url" class="form-control" id="f1-facebook">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="sr-only" for="f2-facebook">Facebook</label>
                                                        <input type="text" name="f2-facebook" placeholder="Facebook" class="form-control" id="f2-facebook">
                                                    </div>
                                                    <div class="form-group">
