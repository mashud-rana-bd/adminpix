...
<!-- Mirrored from adminpix.thememinister.com/maps_amcharts.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:46:05 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body class="hold-transition fixed sidebar-mini">
                    ...
                    <div class="sidebar">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview active">
                                ...
                                <ul class="treeview-menu">
                                    <li class="active"><a href="maps_amcharts.html">Amcharts Maps</a></li>
        ...
        <script src="assets/plugins/amcharts/amcharts-active2.js"></script>
        <!-- START THEME LABEL SCRIPT -->
        <script src="assets/dist/js/theme.js"></script>
    </body>

<!-- Mirrored from adminpix.thememinister.com/maps_amcharts.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:46:07 GMT -->
</html>