...
<!-- Mirrored from adminpix.thememinister.com/form_mask.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:44:49 GMT -->
<head>
        <meta charset="utf-8">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview active">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="active"><a href="form_mask.html">Form Mask</a></li>
                    ...
                    <div class="row">
                                ...
                                <form>
                                    <div class="panel-body">
                                        <div class="form-group row">
                                            <label for="date" class="col-lg-4 col-sm-12 col-form-label">Date</label>
                                        ...
                                        <div class="form-group row">
                                            <label for="time" class="col-lg-4 col-sm-12 col-form-label">Hour</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="date_time" class="col-lg-4 col-sm-12 col-form-label">Date &amp; Hour</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="cep_with_callback" class="col-lg-4 col-sm-12 col-form-label">With Callbacks (open console)</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="money" class="col-lg-4 col-sm-12 col-form-label">Money</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="placeholder" class="col-lg-4 col-sm-12 col-form-label">Mask placeholder option</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="phone_with_ddd" class="col-lg-4 col-sm-12 col-form-label">Telephone with Code Area</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="phone_us" class="col-lg-4 col-sm-12 col-form-label">US Telephone</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="sp_celphones" class="col-lg-4 col-sm-12 col-form-label">São Paulo Celphones</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                    ...
                                    <div class="panel-footer">
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-offset-6">
                                                <button type="button" class="btn btn-cap w-md m-b-5">Submit</button>
                        ...
                        <div class="col-lg-6 col-sm-12 col-md-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4>Mask Plugin Two</h4>
                                    </div>
                                </div>
                                <form>
                                    <div class="panel-body">
                                        <div class="form-group row">
                                            <label for="mixed" class="col-lg-4 col-sm-12 col-form-label">Mixed Type Mask</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="cpf" class="col-lg-4 col-sm-12 col-form-label">CPF</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="cnpj" class="col-lg-4 col-sm-12 col-form-label">CNPJ</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="ip_address" class="col-lg-4 col-sm-12 col-form-label">IP Address</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="cep" class="col-lg-4 col-sm-12 col-form-label">ZIP Code</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="crazy_cep" class="col-lg-4 col-sm-12 col-form-label">Crazy Zip Code</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="clear-if-not-match" class="col-lg-4 col-sm-12 col-form-label">With Clear If Not Match Option</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="fallback" class="col-lg-4 col-sm-12 col-form-label">With a fallback digit</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="selectonfocus" class="col-lg-4 col-sm-12 col-form-label">With selectOnFocus</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-sm-12 col-form-label">Masks on div elements!</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
