...
<!-- Mirrored from adminpix.thememinister.com/button.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:34 GMT -->
<head>
        <meta charset="utf-8">
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    ...
                                    <button type="button" class="btn btn-default w-md m-rb-5">Default</button>
                                    <button type="button" class="btn btn-primary w-md m-rb-5">Primary</button>
                                    <button type="button" class="btn btn-base w-md m-rb-5">Success</button>
                                    <button type="button" class="btn btn-info w-md m-rb-5">Info</button>
                                    <button type="button" class="btn btn-warning w-md m-rb-5">Warning</button>
                                    <button type="button" class="btn btn-danger w-md m-rb-5">Danger</button>
                                    <button type="button" class="btn btn-inverse w-md m-rb-5">Inverse</button>
                                    <button type="button" class="btn btn-purple w-md m-rb-5">Purple</button>
                                    <button type="button" class="btn btn-pink w-md m-rb-5">Pink</button>
                                    <button type="button" class="btn btn-black w-md m-rb-5">Black</button>
                                    <button type="button" class="btn btn-violet w-md m-rb-5">Violet</button>
                                    <button type="button" class="btn btn-base w-md m-rb-5">Base</button>
                                </div>
                            </div>
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                    ...
                                    <button type="button" class="btn btn-default btn-rounded w-md m-rb-5">Default</button>
                                    <button type="button" class="btn btn-primary btn-rounded w-md m-rb-5">Primary</button>
                                    <button type="button" class="btn btn-base btn-rounded w-md m-rb-5">Success</button>
                                    <button type="button" class="btn btn-info btn-rounded w-md m-rb-5">Info</button>
                                    <button type="button" class="btn btn-warning btn-rounded w-md m-rb-5">Warning</button>
                                    <button type="button" class="btn btn-danger btn-rounded w-md m-rb-5">Danger</button>
                                    <button type="button" class="btn btn-inverse btn-rounded w-md m-rb-5">Inverse</button>
                                    <button type="button" class="btn btn-purple btn-rounded w-md m-rb-5">Purple</button>
                                    <button type="button" class="btn btn-pink btn-rounded w-md m-rb-5">Pink</button>
                                    <button type="button" class="btn btn-black btn-rounded w-md m-rb-5">Black</button>
                                    <button type="button" class="btn btn-violet btn-rounded w-md m-rb-5">Violet</button>
                                    <button type="button" class="btn btn-base btn-rounded w-md m-rb-5">Base</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    ...
                                    <button type="button" class="btn btn-default disabled w-md m-rb-5">Default</button>
                                    <button type="button" class="btn btn-primary disabled w-md m-rb-5">Primary</button>
                                    <button type="button" class="btn btn-base disabled w-md m-rb-5">Success</button>
                                    <button type="button" class="btn btn-info disabled w-md m-rb-5">Info</button>
                                    <button type="button" class="btn btn-warning disabled w-md m-rb-5">Warning</button>
                                    <button type="button" class="btn btn-danger disabled w-md m-rb-5">Danger</button>
                                    <button type="button" class="btn btn-inverse disabled w-md m-rb-5">Inverse</button>
                                    <button type="button" class="btn btn-purple disabled w-md m-rb-5">Purple</button>
                                    <button type="button" class="btn btn-pink disabled w-md m-rb-5">Pink</button>
                                    <button type="button" class="btn btn-black disabled w-md m-rb-5">Black</button>
                                    <button type="button" class="btn btn-violet disabled w-md m-rb-5">Violet</button>
                                    <button type="button" class="btn btn-base disabled w-md m-rb-5">Base</button>
                                </div>
                            </div>
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                    ...
                                    <button type="button" class="btn btn-default btn-transparent w-md m-rb-5">Default</button>
                                    <button type="button" class="btn btn-primary btn-transparent w-md m-rb-5">Primary</button>
                                    <button type="button" class="btn btn-base btn-transparent w-md m-rb-5">Success</button>
                                    <button type="button" class="btn btn-info btn-transparent w-md m-rb-5">Info</button>
                                    <button type="button" class="btn btn-warning btn-transparent w-md m-rb-5">Warning</button>
                                    <button type="button" class="btn btn-danger btn-transparent w-md m-rb-5">Danger</button>
                                    <button type="button" class="btn btn-inverse btn-transparent w-md m-rb-5">Inverse</button>
                                    <button type="button" class="btn btn-purple btn-transparent w-md m-rb-5">Purple</button>
                                    <button type="button" class="btn btn-pink btn-transparent w-md m-rb-5">Pink</button>
                                    <button type="button" class="btn btn-black btn-transparent w-md m-rb-5">Black</button>
                                    <button type="button" class="btn btn-violet btn-transparent w-md m-rb-5">Violet</button>
                                    <button type="button" class="btn btn-base btn-transparent w-md m-rb-5">Base</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    ...
                                    <button type="button" class="btn btn-default btn-outline w-md m-rb-5">Default</button>
                                    <button type="button" class="btn btn-primary btn-outline w-md m-rb-5">Primary</button>
                                    <button type="button" class="btn btn-base btn-outline w-md m-rb-5">Success</button>
                                    <button type="button" class="btn btn-info btn-outline w-md m-rb-5">Info</button>
                                    <button type="button" class="btn btn-warning btn-outline w-md m-rb-5">Warning</button>
                                    <button type="button" class="btn btn-danger btn-outline w-md m-rb-5">Danger</button>
                                    <button type="button" class="btn btn-inverse btn-outline w-md m-rb-5">Inverse</button>
                                    <button type="button" class="btn btn-purple btn-outline w-md m-rb-5">Purple</button>
                                    <button type="button" class="btn btn-pink btn-outline w-md m-rb-5">Pink</button>
                                    <button type="button" class="btn btn-black btn-outline w-md m-rb-5">Black</button>
                                    <button type="button" class="btn btn-violet btn-outline w-md m-rb-5">Violet</button>
                                    <button type="button" class="btn btn-base btn-outline w-md m-rb-5">Base</button>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    ...
                                    <button type="button" class="btn btn-default btn-outline btn-rounded w-md m-rb-5">Default</button>
                                    <button type="button" class="btn btn-primary btn-outline btn-rounded w-md m-rb-5">Primary</button>
                                    <button type="button" class="btn btn-base btn-outline btn-rounded w-md m-rb-5">Success</button>
                                    <button type="button" class="btn btn-info btn-outline btn-rounded w-md m-rb-5">Info</button>
                                    <button type="button" class="btn btn-warning btn-outline btn-rounded w-md m-rb-5">Warning</button>
                                    <button type="button" class="btn btn-danger btn-outline btn-rounded w-md m-rb-5">Danger</button>
                                    <button type="button" class="btn btn-inverse btn-outline btn-rounded w-md m-rb-5">Inverse</button>
                                    <button type="button" class="btn btn-purple btn-outline btn-rounded w-md m-rb-5">Purple</button>
                                    <button type="button" class="btn btn-pink btn-outline btn-rounded w-md m-rb-5">Pink</button>
                                    <button type="button" class="btn btn-black btn-outline btn-rounded w-md m-rb-5">Black</button>
                                    <button type="button" class="btn btn-violet btn-outline btn-rounded w-md m-rb-5">Violet</button>
                                    <button type="button" class="btn btn-base btn-outline btn-rounded w-md m-rb-5">Base</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    <button type="button" class="btn btn-labeled btn-base m-b-5">
                                    ...
                                    <button type="button" class="btn btn-base btn-labeled m-b-5">
                        ...
                        <div class="col-sm-4">
                            <div class="panel panel-bd lobidisable">
                                ...
                                <div class="panel-body">
                                    ...
                                    <button type="button" class="btn btn-block btn-social btn-adn m-rb-5">
                                        <span class="fa fa-adn"></span> Sign in with App.net
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-bitbucket m-rb-5">
                                        <span class="fa fa-bitbucket"></span> Sign in with Bitbucket
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-dropbox m-rb-5">
                                        <span class="fa fa-dropbox"></span> Sign in with Dropbox
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-facebook m-rb-5">
                                        <span class="fa fa-facebook"></span> Sign in with Facebook
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-flickr m-rb-5">
                                        <span class="fa fa-flickr"></span> Sign in with Flickr
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-foursquare m-rb-5">
                                        <span class="fa fa-foursquare"></span> Sign in with Foursquare
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-github m-rb-5">
                                        <span class="fa fa-github"></span> Sign in with GitHub
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-google m-rb-5">
                                        <span class="fa fa-google"></span> Sign in with Google
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-instagram m-rb-5">
                                        <span class="fa fa-instagram"></span> Sign in with Instagram
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-linkedin m-rb-5">
                                        <span class="fa fa-linkedin"></span> Sign in with LinkedIn
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-microsoft m-rb-5">
                                        <span class="fa fa-windows"></span> Sign in with Microsoft
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-odnoklassniki m-rb-5">
                                        <span class="fa fa-odnoklassniki"></span> Sign in with Odnoklassniki
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-openid m-rb-5">
                                        <span class="fa fa-openid"></span> Sign in with OpenID
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-pinterest m-rb-5">
                                        <span class="fa fa-pinterest"></span> Sign in with Pinterest
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-reddit m-rb-5">
                                        <span class="fa fa-reddit"></span> Sign in with Reddit
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-soundcloud m-rb-5">
                                        <span class="fa fa-soundcloud"></span> Sign in with SoundCloud
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-tumblr m-rb-5">
                                        <span class="fa fa-tumblr"></span> Sign in with Tumblr
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-twitter m-rb-5">
                                        <span class="fa fa-twitter"></span> Sign in with Twitter
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-vimeo m-rb-5">
                                        <span class="fa fa-vimeo-square"></span> Sign in with Vimeo
                                    </button>
                                    <button type="button" class="btn btn-block btn-social btn-vk m-rb-5">
                                    ...
                                    <button type="button" class="btn btn-social-icon btn-adn m-rb-5"><i class="fa fa-adn"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-bitbucket m-rb-5"><i class="fa fa-bitbucket"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-dropbox m-rb-5"><i class="fa fa-dropbox"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-facebook m-rb-5"><i class="fa fa-facebook"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-flickr m-rb-5"><i class="fa fa-flickr"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-foursquare m-rb-5"><i class="fa fa-foursquare"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-github m-rb-5"><i class="fa fa-github"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-google m-rb-5"><i class="fa fa-google"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-instagram m-rb-5"><i class="fa fa-instagram"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-linkedin m-rb-5"><i class="fa fa-linkedin"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-microsoft m-rb-5"><i class="fa fa-windows"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-odnoklassniki m-rb-5"><i class="fa fa-odnoklassniki"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-openid m-rb-5"><i class="fa fa-openid"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-pinterest m-rb-5"><i class="fa fa-pinterest"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-reddit m-rb-5"><i class="fa fa-reddit"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-soundcloud m-rb-5"><i class="fa fa-soundcloud"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-tumblr m-rb-5"><i class="fa fa-tumblr"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-twitter m-rb-5"><i class="fa fa-twitter"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-vimeo m-rb-5"><i class="fa fa-vimeo-square"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-vk m-rb-5"><i class="fa fa-vk"></i></button>
                                    <button type="button" class="btn btn-social-icon btn-yahoo m-rb-5"><i class="fa fa-yahoo"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    ...
                                    <button type="button" class="btn btn-default btn-circle m-rb-5"><i class="glyphicon glyphicon-ok"></i></button>
                                    <button type="button" class="btn btn-primary btn-circle m-rb-5"><i class="glyphicon glyphicon-list"></i></button>
                                    <button type="button" class="btn btn-base btn-circle m-rb-5"><i class="glyphicon glyphicon-link"></i></button>
                                    <button type="button" class="btn btn-info btn-circle m-rb-5"><i class="glyphicon glyphicon-ok"></i></button>
                                    <button type="button" class="btn btn-warning btn-circle m-rb-5"><i class="glyphicon glyphicon-remove"></i></button>
                                    <button type="button" class="btn btn-danger btn-circle m-rb-5"><i class="glyphicon glyphicon-heart"></i></button>
                                    <button type="button" class="btn btn-inverse btn-circle m-rb-5"><i class="glyphicon glyphicon-trash"></i></button>
                                    <button type="button" class="btn btn-purple btn-circle m-rb-5"><i class="glyphicon glyphicon-repeat"></i></button>
                                    <button type="button" class="btn btn-pink btn-circle m-rb-5"><i class="glyphicon glyphicon-download-alt"></i></button>
                                    <button type="button" class="btn btn-black btn-circle m-rb-5"><i class="glyphicon glyphicon-bell"></i></button>
                                    <button type="button" class="btn btn-violet btn-circle m-rb-5"><i class="glyphicon glyphicon-info-sign"></i></button>
                                    <br>
                                    <br>
                                    ...
                                    <!-- Start button group-->
                                    <div class="btn-group m-rb-5">
                                        <button type="button" data-toggle="dropdown" class="btn dropdown-toggle btn-base">success
                                            <span class="caret"></span>
                                        </button>
                                        <ul role="menu" class="dropdown-menu">
                                            <li><a href="#">Action</a></li>
                                    ...
                                    <!-- Start button group-->
                                    <div class="btn-group  m-rb-5">
                                        <button type="button" class="btn btn-base">Action</button>
                                        <button type="button" data-toggle="dropdown" class="btn dropdown-toggle btn-base">
                                            <span class="caret"></span>
                                    ...
                                    <button type="button" class="btn btn-base btn-rounded"><i class="fa fa-spinner fa-spin"></i></button>
...
<!-- Mirrored from adminpix.thememinister.com/button.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:35 GMT -->
</html>