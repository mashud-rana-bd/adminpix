<!DOCTYPE html>
<html lang="en" data-blast="bgColor">
    
<!-- Mirrored from adminpix.thememinister.com/lockscreen.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:47:07 GMT -->
<head>
        <meta charset="utf-8">
        ...
        <div class="register-wrapper">
            <div class="lock-wrapper-page">
                <div class="text-center">
                    <a href="index.html" class="logo-lock"><i class="icon socicon-feedburner"></i> <span>adminpix</span> </a>
                </div>
                <form method="post" action="http://adminpix.thememinister.com/index.html" class="text-center m-t-20">
                    ...
                    <div class="text-left">
                        <a href="login.html" class="text-muted">Not John Deo ?</a>
                    </div>
                </form>
            </div>
            <!-- /.content-wrapper -->
