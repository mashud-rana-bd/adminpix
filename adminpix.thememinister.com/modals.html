...
<!-- Mirrored from adminpix.thememinister.com/modals.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:44 GMT -->
<head>
        <meta charset="utf-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="column">
                                                ...
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-1">Fade in &amp; Scale</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-2">Slide in (right)</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-3">Slide in (bottom)</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-4">Newspaper</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-5">Fall</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-6">Side Fall</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-7">Sticky Up</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-8">3D Flip (horizontal)</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-9">3D Flip (vertical)</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-10">3D Sign</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-11">Super Scaled</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-12">Just Me</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-13">3D Slit</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-14">3D Rotate Bottom</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-15">3D Rotate In Left</button>
                                                <button class="btn btn-base md-trigger m-b-5 m-r-2" data-modal="modal-16">Blur</button>
                                                <!-- special modal that will add a perspective class to the html element -->
                                                <button class="btn btn-base md-trigger md-setperspective m-b-5 m-r-2" data-modal="modal-17">Let me in</button>
                                                <button class="btn btn-base md-trigger md-setperspective m-b-5 m-r-2" data-modal="modal-18">Make way!</button>
                                                <button class="btn btn-base md-trigger md-setperspective m-b-5 m-r-2" data-modal="modal-19">Slip from top</button>
                                                <!-- the overlay element -->
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="">
                                        <button type="button" class="btn btn-base" data-toggle="modal" data-target="#myModal">Lunch demo modal</button>
                                    </div>
                                    <div class="m-t-20">
                                    ...
                                    <div class="m-b-15">
                                        <button type="button" class="btn btn-base m-r-2 m-b-5" data-toggle="modal" data-target="#modal-success">Success</button>
                                    ...
                                    <div class="m-t-20">
                                        <pre>var modalInstance = $modal.open({
...
<!-- Mirrored from adminpix.thememinister.com/modals.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Nov 2018 16:45:46 GMT -->
</html>